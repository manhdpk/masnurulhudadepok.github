import img1 from "@/assets/berita/level up AI.jpg";
import img2 from "@/assets/berita/pramuka.jpg";
...
MA Nurul Huda berharap semangat yang ditanamkan melalui kegiatan ini dapat membentuk generasi muda yang tangguh, berkarakter, dan siap menghadapi tantangan zaman.
  ...
  },
  {
    ...
    excerpt:
      "Selamat kami ucapkan kepada para juara Program LEVEL UP AI yang telah berhasil menunjukkan prestasi gemilang dalam ajang yang bertujuan menumbuhkan kreativitas dan literasi kecerdasan buatan (AI) di kalangan generasi muda.",
    image: img1,
    content: `
      Program ini terselenggara berkat kolaborasi antara Vox Digital Kreatif dan Yayasan Keluarga Alumni Paskibra 99, yang berkomitmen menghadirkan wadah pembelajaran serta pengembangan kemampuan teknologi AI bagi para peserta. Inisiatif ini menjadi langkah penting dalam mempersiapkan generasi muda untuk menghadapi tantangan di era digital.
Kegiatan ini tidak hanya meningkatkan kemampuan teknis para peserta, tetapi juga memperkuat semangat inovasi dan kreativitas dalam pengembangan solusi berbasis AI yang bermanfaat bagi masyarakat luas.
Dengan adanya program seperti LEVEL UP AI, diharapkan semakin banyak generasi muda yang terinspirasi dan mampu mengembangkan potensinya dalam bidang teknologi, sehingga dapat berkontribusi pada kemajuan bangsa dan negara.
    `,
  },
];
